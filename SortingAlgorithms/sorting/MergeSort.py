...
class MergeSort():
  ...
  def mergesort(self, ar):
      ...
      # Trigger the callback when the array structure changes
      if self.callback:
          self.callback()
  ...
  def register_callback(self, callback_func):
      """
      Registers the callback function to be triggered when the array structure changes.
      """
...
if __name__ == '__main__':
  ...
  """
  def callback():
      print("Array structure changed!")
  
  array = [10, 4, 6, 4, 8, -13, 2, 3]
  sorter = MergeSort()
  sorter.register_callback(callback)
